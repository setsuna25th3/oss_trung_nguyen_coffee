<?php
    ...
    $productId = $_SESSION['currentProductId'] ?? null;
    if ($productId === null) {
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <img src="Images/SanPham/<?php echo $product['Img']; ?>" class="img-thumbnail rounded" alt="<?php echo $product['Title']; ?>" style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-xl-3">
                    ...
                    <div>
                        ...
                        <?php foreach ($featuredProducts as $fp): ?>
                            <div class="d-flex mb-2">
                                <img src="Images/SanPham/<?php echo $fp['Img']; ?>" style="width:60px; height:60px; object-fit:cover; margin-right:10px;">
                                <div>
                ...
                <?php foreach ($relatedProducts as $rp): ?>
                    <div class="col-md-4">
                        <div class="border p-2">
                            <img src="Images/SanPham/<?php echo $rp['Img']; ?>" class="img-fluid">
