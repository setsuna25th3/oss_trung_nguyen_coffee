    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <div class="sidebar-section">
                ...
                <div class="featured-product">
                     <img src="../../../images/SanPham/caphe-sua.jpg" alt="Sản phẩm nổi bật">
                    <div>
                        <h4>Cà phê sữa đá</h4>
                        <p>25.000 VND</p>
                    </div> 
                ...
                <div class="featured-product">
                    <img src="../../../images/SanPham/30.-Tra-Dao-Cam-Sa.png" alt="Sản phẩm nổi bật">
                    <div>
            ...
            <div class="sidebar-section">
                <h3>Sản phẩm mới</h3>
                 ...
                 <div class="featured-product">
                    <img src="../../../images/SanPham/camvat.jpg" alt="Sản phẩm mới">
                    <div>
                        <h4>Nước đá cam</h4>
                        <p>25.000 VND</p>
                    </div>
            ...
            <div class="sidebar-section">
                ...
                < <div class="featured-product">
                    <img src="../../../images/SanPham/24.-Picasso-Latte-2-_-No.png" alt="Sản phẩm bán chạy">
                    <div>
                        <h4>Latte</h4>
                        <p>30.000 VND</p>
                    </div>
        ...
        <main class="main-content">
            ...
            <div class="products-grid">
                <?php for ($i = 1; $i <= 8; $i++): ?>
                    <div class="card">
                        <div class="position-absolute top-0 start-0 bg-secondary text-white px-3 py-1 rounded m-2"></div>
                        <img src="../../../images/SanPham/camvat.jpg" alt="Product">
                        <div class="card-body">
