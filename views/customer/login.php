...
// Giả lập dữ liệu TempData["SignInSuccessMessage"]
$signInSuccessMessage = $_SESSION['SignInSuccessMessage'] ?? '';
unset($_SESSION['SignInSuccessMessage']); // Xóa sau khi hiển thị
    ...
    <div class="login-table">
        ...
        <form method="post" action="sign_in_process.php?returnUrl=<?= urlencode($returnUrl) ?>">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2"><button type="submit" class="btn btn-primary mt-3">Đăng nhập</button></td>
                </tr>
            </table>

            <div class="text-center mt-3">
                Chưa có tài khoản? <a href="../customer/signup.php">Đăng ký</a>
            </div>
